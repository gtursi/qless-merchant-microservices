...
public interface MerchantApi {
    ...
    @ApiOperation(value = "Returns a uniquely-identified merchant location",
            nickname = "merchantLocationGet",
            notes = "This method returns a single merchant location that matches a unique global identifier. " +
                    "The global identifier is returned in a NetworkSource entity with a 'location' type, usually in response to a location search query.",
            response = Location.class, tags={ "default", })
    @ApiResponses(value = { 
...
//        consumes = { "application/json" },
    ...
    ResponseEntity<Location> merchantLocationGet(
    ...
    @ApiOperation(value = "Returns merchant locations that match search criteria",
            nickname = "merchantLocationSearch",
            notes = "This method identifies valid locations that match ALL provided search criteria. " +
                    "Simpler queries work best for experimentation and early development, whereas multi-parameter queries permit strict optimization of client data usage.",
            response = Location.class, responseContainer = "List", tags={ "default", })
    @ApiResponses(value = { 
...
//        consumes = { "application/json" },
        method = RequestMethod.GET)
    ResponseEntity<List<Location>> merchantLocationSearch(
